...
export class Horse2 extends React.Component {
    constructor(props) {
      ...
      this.calcBtnDisabled = this.calcBtnDisabled.bind(this);
      this.state = {
        count: 0,
        constraintState: "",
    ...
    calcBtnDisabled = () => {
        console.log("Horse2 calcBtnDisabled");
        if (this.state.calcBtnDisabled) {
            return true;
        }
        return false;
    ...
    render() {
      ...
      return (
        <View style={styles.container}>
          ...
          <CalcPage clearAll={ ()=>this.clearAll() } 
            calcBtnDisabled={()=>this.calcBtnDisabled()}
